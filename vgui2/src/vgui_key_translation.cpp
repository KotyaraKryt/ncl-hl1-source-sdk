...
//===========================================================================//
    ...
    #include <winuser.h>
#else
    // Standard Win32 virtual-key codes (winuser.h), used below as array indices.
    // No Linux input backend feeds real key codes into this table yet, so these
    // are just kept numerically identical to Windows for whenever one does.
    #define VK_BACK      0x08
    #define VK_TAB       0x09
